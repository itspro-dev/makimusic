        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                  ...
                  InlineKeyboardButton(text="SUPPORT", url="https://t.me/mizuhara_help_support"),
                ],
                 [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="🎥 YouTube", url=f"{url}"),
                        InlineKeyboardButton(text="JOIN", url=f"https://t.me/mizuhara_help_support"),
                    ],
                    [InlineKeyboardButton(text="🗑Close", callback_data="cls")],
                ]
            )
...
async def ytplay(_, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                  InlineKeyboardButton(text="🎥 YouTube", url=f"{url}"),
                  InlineKeyboardButton(text="SUPPORT", url=f"https://t.me/mizuhara_help_support"),
                ],
                 [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
    )
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="🎥 **Playing** here the song requested by {} via Youtube Music 😉 join @mizuhara_help_support".format(
                message.from_user.mention()
            ),
        )
        os.remove("final.png")
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> helper Userbot not in this chat, Ask admin to send /play command for first time or add @ChizuruMusic_Assistant manually</i>"
        )
        return
    requested_by = message_.from_user.first_name
    chat_id = message_.chat.id
         ...
         [
            [
                InlineKeyboardButton(
                    text="JOIN", url=f"https://t.me/mizuhara_help_support"
                )
            ],
            [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
        ]
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✯{bn}✯=#️⃣ Queued at position {position} join @mizuhara_help_support",
        )
...
async def lol_cb(b, cb):
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            caption=f"#⃣  Song requested by {r_by.mention} **queued** at position {position}! Join @mizuhara_help_support",
            reply_markup=keyboard,
        )
        os.remove("final.png")
